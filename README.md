...
| [Bonfyre Agent Trace Verifier](https://github.com/Nickgonzales76017/bonfyre-agent-trace-verifier) | Deterministic offline verifier for governed agent-workflow traces, covering policy boundaries, tool use, provenance, replayability, redaction, and evidence integrity. Ships as a CLI and composite GitHub Action with versioned schemas and fixtures. | ![GitHub stars](https://img.shields.io/github/stars/Nickgonzales76017/bonfyre-agent-trace-verifier?style=social) |
