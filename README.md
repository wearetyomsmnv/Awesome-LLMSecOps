...
| [SandBase Harness](https://github.com/sandbaseai/sandbase-harness) | Local-first, self-hostable AI agent runtime that combines sandboxed tools, credential boundaries, policy controls, audit logs, event replay, and an MCP bridge. Deployment-dependent isolation and security posture; not a security certification or endorsement. | ![GitHub stars](https://img.shields.io/github/stars/sandbaseai/sandbase-harness?style=social) |
